...
# en: SelfBot name
# fr: Nom du SelfBot
selfbot_name = "Atomic" # Tip: Don't use the "Selfbot" word into your selfbot name, most of servers blacklist this word with AutoMod
...
ban_reason = "ezzed by Zack lol."
kick_reason = "ezzed by Zack lol."
...
activity_button_one = "Zack !"
activity_button_one_answer = "https://github.com/Sitois/Zack" # doesn't work for the moment
activity_button_two = "Star it!"
activity_button_two_answer = "https://github.com/Sitois/Zack" # doesn't work for the moment
